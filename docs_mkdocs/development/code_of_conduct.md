...
- **Open an issue** on the [GitHub repository](https://github.com/emilioxavier/msuthemes-py/issues) with the label "code of conduct"
- **Email the project maintainer** directly (see contact information in the README)
- **Use GitHub's reporting features** if the issue involves repository content
