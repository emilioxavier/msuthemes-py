...
- Homepage: [https://github.com/emilioxavier/msuthemes-py](https://github.com/emilioxavier/msuthemes-py)
- Documentation: [https://emilioxavier.github.io/msuthemes-py/](https://emilioxavier.github.io/msuthemes-py/)
- Repository: [https://github.com/emilioxavier/msuthemes-py](https://github.com/emilioxavier/msuthemes-py)
- Bug Tracker: [https://github.com/emilioxavier/msuthemes-py/issues](https://github.com/emilioxavier/msuthemes-py/issues)
- Original R Package: [https://cran.r-project.org/package=MSUthemes](https://cran.r-project.org/package=MSUthemes)
...
!!! note "Alpha Release"
    This is an alpha release (0.1.0). The API may change in future versions.
